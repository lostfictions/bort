...
export function isAddConceptAction(action: {
  type: string;
}): action is AddConceptAction {
...
export function isRemoveConceptAction(action: {
  type: string;
}): action is RemoveConceptAction {
...
export function isLoadConceptAction(action: {
  type: string;
}): action is LoadConceptAction {
...
export function isAddToConceptAction(action: {
  type: string;
}): action is AddToConceptAction {
...
export function isRemoveFromConceptAction(action: {
  type: string;
}): action is RemoveFromConceptAction {
